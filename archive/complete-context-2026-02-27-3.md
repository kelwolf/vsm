...
- rebuild-notion.py — rebuild script
- demo-pipeline.py — demo script
- .claude/settings.local.json

### ~/medicine-basket-goods/ (GitHub: kelwolf/medicine-basket-goods)
- CLAUDE.md — session init (reads ~/core then this project)
